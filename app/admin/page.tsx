          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border-t pt-4">
                <Label htmlFor="paste-json" className="text-muted-foreground">Or paste payload (JSON)</Label>
                <form onSubmit={handleImportPaste} className="mt-2 space-y-2">
                  <textarea
                    id="paste-json"
                    placeholder='{"name": "...", "width": 1080, "height": 1350, "nodes": [...]}'
                    value={pasteJson}
